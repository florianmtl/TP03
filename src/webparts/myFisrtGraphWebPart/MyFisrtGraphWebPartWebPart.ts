...
import styles from './MyFisrtGraphWebPartWebPart.module.scss';
import * as strings from 'MyFisrtGraphWebPartWebPartStrings';
import { MSGraphClient } from '@microsoft/sp-http';
import * as MicrosoftGraph from '@microsoft/microsoft-graph-types';

export interface IMyFisrtGraphWebPartWebPartProps {
  description: string;
}

export default class MyFisrtGraphWebPartWebPart extends BaseClientSideWebPart<IMyFisrtGraphWebPartWebPartProps> {
  ...
  public render(): void {
    ...
    .then((client: MSGraphClient): void => {
      ...
      .get((error, messages: any, rawResponse?: any) => {
        ...
        <div class="${ styles.myFisrtGraphWebPart}">
